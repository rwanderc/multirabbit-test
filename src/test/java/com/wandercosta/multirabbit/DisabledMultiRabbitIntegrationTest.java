...
public class DisabledMultiRabbitIntegrationTest {
    ...
    void shouldListenToDefault() {
        final AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(
                TestConfigs.DisabledMultiRabbitConfig.class, RabbitAutoConfiguration.class,
                MultiRabbitAutoConfiguration.class, DisabledMultiRabbitIntegrationTest.ListenerBeans.class);
